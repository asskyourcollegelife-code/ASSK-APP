...
import { FileText, Download, MoreVertical, Search, Filter, Tag } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {notes && notes.length > 0 ? (
                    notes.map((note) => (
                        <div key={note.id} className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group flex flex-col h-full cursor-pointer relative overflow-hidden">
                    ...
                    <div className="col-span-full py-20 text-center bg-white rounded-3xl border border-gray-100 shadow-sm flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-500">Be the first to upload study material for this department.</p>
                    </div>
                )}
            </div>
